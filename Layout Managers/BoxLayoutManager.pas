...
begin
  ...
  if Assigned(PrecedingLayoutItemVisualSettingsHolder) then begin
...
begin
  ...
  if not Assigned(FirstLayoutItemVisualSettingsHolder) then begin
...
begin
  ...
  if Assigned(FirstLayoutItemVisualSettingsHolder) then
