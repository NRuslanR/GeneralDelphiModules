  ...
  type
    ...
    TAbstractRepository = class abstract (TInterfacedObject, IDomainObjectRepository)
      ...
      strict protected
        ...
        function CreateDomainObject(DataReader: IDataReader): TDomainObject; virtual; abstract;
        function CreateDomainObjectList(DataReader: IDataReader): TDomainObjectList; virtual;
        
        function CreateAndFillDomainObjectFromDataReader(
          DataReader: IDataReader
        ): TDomainObject; 

        function CreateAndFillDomainObjectListFromDataReader(
          DataReader: IDataReader
...
function TAbstractRepository.CreateDomainObjectList(DataReader: IDataReader): TDomainObjectList;
begin
...
function TAbstractRepository.CreateAndFillDomainObjectFromDataReader(
  DataReader: IDataReader
): TDomainObject;
begin
  ...
  FillDomainObjectFromDataReader(Result, DataReader);

  Result.InvariantsComplianceRequested := True;
  
end;

function TAbstractRepository.CreateAndFillDomainObjectListFromDataReader(
  DataReader: IDataReader
): TDomainObjectList;
begin

  Result := CreateDomainObjectList(DataReader);

  FillDomainObjectListFromDataReader(Result, DataReader);
...
begin
  ...
  FreeAndNil(FRepositoryErrorCreator);
...
function TAbstractRepository.Save(DomainObject: TDomainObject): Boolean;
begin

  if not DomainObject.IsIdentityAssigned then
    Result := Add(DomainObject)

  else Result := Update(DomainObject);
...
procedure TAbstractRepository.OnFoundDomainObjectsByIdentities(
  FoundDomainObjects: TDomainObjectList);
begin
