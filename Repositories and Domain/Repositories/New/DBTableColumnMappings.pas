...
type
  ...
  TDBTableColumnMapping = class (TTableColumnMapping)
    ...
    public
      ...
      function GetColumnNameOrAliasName: String; 
...
function TDBTableColumnMapping.GetColumnNameOrAliasName: String;
begin

  Result := IfThen(Trim(AliasColumnName) <> '', AliasColumnName, ColumnName);
